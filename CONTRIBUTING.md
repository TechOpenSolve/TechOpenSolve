# Contributing to TechOpenSolve Live Site Repo
...
Do not open issues for general support questions as we want to keep GitHub issues for Contribution Acknowledgments, bug reports and feature requests.
Instead, we recommend using Discussions to ask support-related questions.


## Types of Issues

Here you can document the following Issue types without prior discussion:
- **CONTRIBUTION ACKNOWLEDGMENTS** - that have gone through all the stages and are approved to be featured on the live website

- **FEATURE** - suggestions of implementing something new that has not been worked on before and does not exist on the site
- **BUG** - correcting something that has been worked on before but is not functioning as intended

## Submitting an Issue

Before opening an issue, please search through Issues to see if a similar issue has been raised.

### Contribution Acknowledgments have a higher priority over all other issues.
...
Before starting work on any issue, it is essential to confirm that it has not already been addressed.
...
1. Search [TechOpenSolve](https://github.com/TechOpenSolve/TechOpenSolve/pulls) for an open or closed PR that relates to your submission.
   You don't want to duplicate existing efforts.

2. Be sure that an issue describes the contribution acknowledgment, the problem you're fixing, or documents the design for the feature you'd like to add.
   Discussing the design upfront helps to ensure that we're ready to accept your work.

3. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the `TechOpenSolve` repo.
...
10. In GitHub, send a pull request to `TechOpenSolve/TechOpenSolve:develop`.
...
The Pages folder contains the components that correspond to the category repositories of the project.
